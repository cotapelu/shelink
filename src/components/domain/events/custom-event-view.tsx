...
import { CustomEventFormFields } from "./custom-event-form-fields";
...
export function CustomEventFormView({ name, eventDate, location, content, setName, setEventDate, setLocation, setContent, error, loading, isEdit, onCancel, onDelete, onSubmit }: CustomEventFormViewProps) {
  return (
    <>
      {error && (
        <motion.div

/**
 * Pure helper functions for intakes - extracted for testability
 */
...
export type IntakeConflictGateInput = {
...
export function clientTypeToPartyType(type: "INDIVIDUAL" | "COMPANY" | string): PartyType {

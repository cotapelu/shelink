...
describe("parseGedcomDate", () => {
  ...
  it("returns null for partial with invalid month", () => {
    ...
    expect(result).toEqual({ day: 15, month: null, year: 2024 });
  });

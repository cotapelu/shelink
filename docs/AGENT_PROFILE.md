...
| 2025-07-07 | Testing | Func coverage ~63% <80% | HIGH | In progress (+32 functions across 9 modules: notification, express, intake, announcements, analytics, genealogy, search, schedule, firm-files); added firm-files; complex modules (clients, settings, notes, tasks) deferred; 63.45% coverage

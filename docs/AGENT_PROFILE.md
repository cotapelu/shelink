...
| 2025-07-07 | Testing | Func coverage ~65% <80% | HIGH | In progress (+49 functions across 12 modules: notification, express, intake, announcements, analytics, genealogy, search, schedule, firm-files, clients, tasks, notes); added notes (4 functions); 64.47% coverage

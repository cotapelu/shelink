...
| 2025-07-07 | Testing | Func coverage ~66% <80% | HIGH | In progress (+74 functions across 15 modules: notification, express, intake, announcements, analytics, genealogy, search, schedule, firm-files, clients, tasks, notes, external-contacts, users, procedures); added procedures (11 functions); 65.78% coverage

...
| 2025-07-07 | Testing | Func coverage ~63% <80% | HIGH | In progress (+20 functions across 4 modules); attempted clients/settings/notes but complexity high; need test helpers

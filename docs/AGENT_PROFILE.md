...
| 2025-07-07 | Testing | Func coverage ~63% <80% | HIGH | In progress (+25 functions across 6 modules: notification, express, intake, announcements, analytics, genealogy); added reminders, ai; complex modules (clients, settings, notes, tasks) deferred; 62.53% coverage

...
| 2025-07-07 | Testing | Func coverage ~66% <80% | HIGH | In progress (+77 functions across 16 modules: notification, express, intake, announcements, analytics, genealogy, search, schedule, firm-files, clients, tasks, notes, external-contacts, users, procedures, settings); added settings (3 functions); 65.97% coverage

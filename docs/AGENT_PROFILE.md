...
| 2025-07-07 | Testing | Func coverage ~63% <80% | HIGH | In progress (+22 functions across 5 modules: notification, express, intake, announcements, analytics); complex modules (clients, settings, notes, tasks) deferred pending test helpers
